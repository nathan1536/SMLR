...
class ConfigAdvanced:
    ...
    def get_config_dict():
        config_dict = {
            ...
            'robotic_tool':        "2_gripper",         # (*) Options: '3_gripper', '2_gripper', 'calibration_pin', 'None' (string). Also, 'end_effector' should be set to True.
            ...
            # parameter to select mlp+r3m or r3m (backbone options: vgg or r3m)
            # combinations allowed are 1. r3m 2. r3m +mlp 3. vgg16 + mlp
            ...
            'backbone': 'vgg16',
            'use_mlp': True,  # if use_mlp is False then 'backbone' must be 'r3m'
    ...
    def get_goal_dict(self):
        ...
        if(goal_dict["goal_type"] == "box"):
            goal_dict_box = {
                ...
                'box_z_min':             0.42,
                'box_z_max':             0.67,
                'box_ry_active':         False,                                # If set to False -> Boxes will have a fixed rotation (0.0 deg)
                'box_ry_min':            -90,
                'box_ry_max':            0,
    ...
    def get_reward_dict():
        ...
        reward_dict = {
            ...
            'reward_pose_weight':     0.0,         # Important: Set 'reward_pose_weight': 0.0  to activate 2DoF control
...
if __name__ == "__main__":
    ...
    xml_file = "./simulator/v0.9/Linux/ManipulatorEnvironment_ConfigurableJoints/configuration.xml" # Change the path if needed
