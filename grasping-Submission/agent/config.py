...
class Config:
    ...
    def get_config_dict():
        config_dict = {
            ...
            'camera_position': [0.0, 2.0, -2.0],         # (*) UNITY
            'camera_rotation': [45.0, 0.0, 0.0],      # (*)
            ...
            'initial_positions': [0.0, 0.0, 0.0, -1.64, 0.0, 1.50, 0.0],                                      # Example options: [0, 0, 0, 0, 0, 0, 0] same as None, [0, 0, 0, -np.pi/2, 0, np.pi/2, 0]
