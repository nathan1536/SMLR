...
class RandomBoxesGenerator:
    def __init__(self, box_mode="train", box_samples=400, box_split=0.1, box_save_val=False, box_load_val=False,
                 box_radius_val=0.01, box_min_distance_base=0.35, box_max_distance_base=0.6, box_folder="./agent/logs/dataset/",
                 box_x_min=-0.6, box_x_max=0.6, box_x_active=True, box_z_min=-0.6, box_z_max=0.6, box_z_active=True,
    ...
    def random_box_positions(self):
        ...
        z = np.random.choice(value2)
        # x = -0.4
        # z = 0.6  # fixed box position, right in front of manipulator.
    ...
    def _load_val(self):
        ...
        # print(f"val-set:{val_set_file}")
        # self.objects_X_val.append(val_set_file[0])
        # self.objects_Y_val.append(val_set_file[1])
        # self.objects_Z_val.append(val_set_file[2])
        # self.objects_RY_val.append(val_set_file[3])
        ...
        self.objects_RY_val = np.asarray(self.objects_RY_val)
