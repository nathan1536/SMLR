...
def _update_envs_manual_and_check_collisions(vec_env, envs_active, rews, observations, enable_rewards=True):
    ...
    for env in envs_active:
        observation = observations[env.id] # observation for single env
        ...
        # TODO
        images = vec_env._get_image_from_simulator_obs(observation)
        mlp_obs = vec_env._return_image_based_observation(images)
